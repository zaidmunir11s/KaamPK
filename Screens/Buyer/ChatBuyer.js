...
export default class ChatBuyer extends React.Component {
  ...
  getData() {
    ...
    const subscriber = MessageController.ViewMyMessages(this.props.route.params.to, this.props.route.params.from, (data) => {
      users = []
  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView
        ...
        <View style={{ flex: 10, backgroundColor: '#009387', justifyContent: "space-around" }} >
          <Text style={{ alignSelf: "flex-start", color: 'white', fontSize: 28, fontWeight: 'bold', margin: 20 }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                MessageController.SaveBuyerMsg(this.props.route.params.from, this.props.route.params.to, this.message)
                this.setState({ value: '' })
                this.forceUpdate()
