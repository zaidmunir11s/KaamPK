...
export default class ChatBuyer extends React.Component {
  ...
  getData() {
    ...
    const subscriber = MessageController.ViewMyMessages(this.props.route.params.from, this.props.route.params.to, (data) => {
      users = []
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                MessageController.SaveMsg(this.props.route.params.from, this.props.route.params.to, this.message, 'Seller')
                this.setState({ value: '' })
                this.forceUpdate()
